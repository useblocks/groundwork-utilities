...
try:
    release = pkg_resources.get_distribution('groundwork_utilities').version
except pkg_resources.DistributionNotFound:
    print('groundwork utilities must be installed to build the documentation.')
...
html_theme_options = {
    "contribute": True,
    "github_fork": "useblocks/groundwork-utilities",
...
#
# html_title = 'groundwork utilities v0.1'
...
htmlhelp_basename = 'groundwork utilitiesdocs'
...
latex_documents = [
    (master_doc, 'groundwork utilities.tex', 'groundwork utilities Documentation',
...
man_pages = [
    (master_doc, 'groundwork utilities', 'groundwork utilities Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'groundwork utilities', 'groundwork utilities Documentation',
     author, 'groundwork utilities', 'One line description of project.',
     'Miscellaneous'),
]
